...
* 菱形继承带来的主要问题是子类**继承两份相同的数据**，导致资源浪费以及毫无意义
* 利用**虚继承virtual 虚基指针vbptr指向表同一个数据**可以解决菱形继承问题
...
* **动态多态virtual --vfptr虚函数指针表**的函数地址晚绑定  -  **运行阶段**确定函数地址
...
多态使用时，如果**子类中有属性开辟到堆区**，那么**父类指针在释放时无法调用到子类**的析构代码
